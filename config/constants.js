...
module.exports = {
  ...
  // Lista de admins para receber resumos/avisos
  ADMIN_NUMBERS: [
    '559870278100@c.us',
    '559870035468@c.us',
  ],

  // Número do entregador para receber resumos de delivery
  ENTREGADOR_NUMBER: '559870278100@c.us',

  // Lista de entregadores para receber resumos de delivery
  ENTREGADOR_NUMBERS: [
    '559870278100@c.us',
    '559870035468@c.us',
  ],

  // Lista de números ignorados (não processa mensagens desses contatos)
  IGNORED_NUMBERS: [
    '559870035468@c.us',
    '559885767708@c.us',
    '559899349897@c.us',
